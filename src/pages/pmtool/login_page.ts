...
import { ForgottenPasswordPage } from "./lost_password_page.ts";
...
export class LoginPage {
  ...
  private readonly forgottenPwdButton: Locator;
  ...
  constructor(page: Page) {
    ...
    this.forgottenPwdButton = page.locator("#forget_password");
  }
  ...
  async clickPasswordForgotten(): Promise<ForgottenPasswordPage> {
    await this.forgottenPwdButton.click();
